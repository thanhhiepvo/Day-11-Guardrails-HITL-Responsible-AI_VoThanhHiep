...
class OutputGuardrailPlugin(base_plugin.BasePlugin):
    """Plugin that redacts PII/secrets from agent output before sending to user."""

    def __init__(self, use_llm_judge=False, audit_log=None):
        ...
        self.total_count = 0
        self.last_redaction: dict | None = None
